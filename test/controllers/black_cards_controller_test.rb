...
class BlackCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create black_card" do
    assert_difference('BlackCard.count') do
      post black_cards_url, params: { black_card: { pick_amount: @black_card.pick_amount, text: @black_card.text } }
    end
  ...
  test "should update black_card" do
    patch black_card_url(@black_card), params: { black_card: { pick_amount: @black_card.pick_amount, text: @black_card.text } }
